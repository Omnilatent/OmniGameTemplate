...
{
    public static class GithubBuildScript
    {
        const string androidAppBundle = "androidAppBundle";
                ...
                case BuildTarget.Android:
                    {
                        ...
                        if(options.TryGetValue(androidAppBundle, out string androidAppBundleStr) &&
                            bool.TryParse(androidAppBundleStr, out bool buildAndroidAppBundle))
                        {
                            EditorUserBuildSettings.buildAppBundle = buildAndroidAppBundle;
                        }
                        Console.WriteLine($"Setting build app bundle: {EditorUserBuildSettings.buildAppBundle}");
